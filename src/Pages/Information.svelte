...
<svelte:head>
  <title>Information - 湊あくあ | Minato Aqua Fanpage</title>
</svelte:head>
  ...
  <Row>
    <Col>
      ...
      <div id="personal">
        ...
        <p>
          <strong>Weight</strong> : {weight} (Please don't ask a girl for their weight!)
        </p>
        <p><strong>Hobbies</strong> : {hobby[0]} and {hobby[1]}</p>
        <p>
          <strong>Likes</strong> : {likeThings[0]}, {likeThings[1]}, and {likeThings[2]}
        </p>
